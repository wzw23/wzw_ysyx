...
# 26 "src/utils/elf.c" 3 4
           ,
           "src/utils/elf.c", 26, __extension__ __PRETTY_FUNCTION__);
   }))
# 26 "src/utils/elf.c"
      ;
...
# 29 "src/utils/elf.c" 3 4
           ,
           "src/utils/elf.c", 29, __extension__ __PRETTY_FUNCTION__);
   }))
# 29 "src/utils/elf.c"
      ;

  flag = fseek(fp, elf_head.e_shoff,
# 31 "src/utils/elf.c" 3 4
               0
# 31 "src/utils/elf.c"
  );

# 32 "src/utils/elf.c" 3 4
  ((void)sizeof((
# 32 "src/utils/elf.c"
                    flag == 0
# 32 "src/utils/elf.c" 3 4
...
# 32 "src/utils/elf.c" 3 4
           ,
           "src/utils/elf.c", 32, __extension__ __PRETTY_FUNCTION__);
   }))
# 32 "src/utils/elf.c"
      ;
...
# 35 "src/utils/elf.c" 3 4
           ,
           "src/utils/elf.c", 35, __extension__ __PRETTY_FUNCTION__);
   }))
# 35 "src/utils/elf.c"
      ;

  fseek(fp, shdr[elf_head.e_shstrndx].sh_offset,
# 37 "src/utils/elf.c" 3 4
        0
# 37 "src/utils/elf.c"
  );
# 60 "src/utils/elf.c"
  ...
  for (i = 0; i < elf_head.e_shnum; i++) {
    if ((shdr[i].sh_type ==
# 62 "src/utils/elf.c" 3 4
         2
# 62 "src/utils/elf.c"
         ) ||
        (shdr[i].sh_type ==
# 63 "src/utils/elf.c" 3 4
         11
# 63 "src/utils/elf.c"
         )) {

      Elf64_Sym *sydr =
          (Elf64_Sym *)malloc(sizeof(Elf64_Sym) * shdr[i].sh_size);
      fseek(fp, shdr[i].sh_offset,
# 68 "src/utils/elf.c" 3 4
            0
# 68 "src/utils/elf.c"
      );
      flag = fread(sydr, shdr[i].sh_size, 1, fp);

# 70 "src/utils/elf.c" 3 4
      ((void)sizeof((
# 70 "src/utils/elf.c"
                        flag != 0
# 70 "src/utils/elf.c" 3 4
...
# 70 "src/utils/elf.c" 3 4
               ,
               "src/utils/elf.c", 70, __extension__ __PRETTY_FUNCTION__);
       }))
# 70 "src/utils/elf.c"
          ;
      ...
      fseek(fp, shdr[systrtab_ndx].sh_offset,
# 75 "src/utils/elf.c" 3 4
            0
# 75 "src/utils/elf.c"
      );
      flag = fread(systrtab, shdr[systrtab_ndx].sh_size, 1, fp);

# 77 "src/utils/elf.c" 3 4
      ((void)sizeof((
# 77 "src/utils/elf.c"
                        flag != 0
# 77 "src/utils/elf.c" 3 4
...
# 77 "src/utils/elf.c" 3 4
               ,
               "src/utils/elf.c", 77, __extension__ __PRETTY_FUNCTION__);
       }))
# 77 "src/utils/elf.c"
          ;
