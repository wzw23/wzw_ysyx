...
# 90 "src/cpu/difftest/dut.c" 3 4
           ,
           "src/cpu/difftest/dut.c", 90, __extension__ __PRETTY_FUNCTION__);
   }))
# 90 "src/cpu/difftest/dut.c"
      ;
...
# 93 "src/cpu/difftest/dut.c" 3 4
  ((void)sizeof((
# 93 "src/cpu/difftest/dut.c"
                    ref_difftest_init
# 93 "src/cpu/difftest/dut.c" 3 4
                    )
                    ? 1
...
# 93 "src/cpu/difftest/dut.c" 3 4
           ,
           "src/cpu/difftest/dut.c", 93, __extension__ __PRETTY_FUNCTION__);
   }))
# 93 "src/cpu/difftest/dut.c"
      ;
  ...
  do {
    printf("\33[1;34m"
           "[%s:%d %s] "
           "Differential testing: %s"
           "\33[0m"
           "\n",
           "src/cpu/difftest/dut.c", 95, __func__,
           "\33[1;32m"
           "ON"
           "\33[0m");
    do {
      extern FILE *log_fp;
      extern
# 95 "src/cpu/difftest/dut.c" 3 4
          _Bool
# 95 "src/cpu/difftest/dut.c"
          log_enable();
      if (log_enable()) {
        fprintf(log_fp,
                "\33[1;34m"
  ...
  do {
    printf("\33[1;34m"
           "[%s:%d %s] "
           "The result of every instruction will be compared with %s. "
           "This will help you a lot for debugging, but also significantly "
           "reduce the performance. "
           "If it is not necessary, you can turn it off in menuconfig."
           "\33[0m"
           "\n",
           "src/cpu/difftest/dut.c", 96, __func__, ref_so_file);
    do {
      extern FILE *log_fp;
      extern
# 96 "src/cpu/difftest/dut.c" 3 4
          _Bool
# 96 "src/cpu/difftest/dut.c"
          log_enable();
      if (log_enable()) {
        fprintf(log_fp,
                "\33[1;34m"
                "[%s:%d %s] "
                "The result of every instruction will be compared with %s. "
                "This will help you a lot for debugging, but also "
  ...
  ref_difftest_memcpy((((paddr_t)0x80000000) + 0x0),
                      guest_to_host((((paddr_t)0x80000000) + 0x0)), img_size,
                      DIFFTEST_TO_REF);
...
# 130 "src/cpu/difftest/dut.c"
    ...
    if (is_skip_ref) {
      ...
      ref_difftest_regcpy(&cpu, DIFFTEST_TO_REF);
      is_skip_ref =
# 137 "src/cpu/difftest/dut.c" 3 4
          0
# 137 "src/cpu/difftest/dut.c"
          ;
      return;
    }
...
void difftest_attach() {
  ...
  ref_difftest_memcpy((((paddr_t)0x80000000) + 0x0),
                      guest_to_host((((paddr_t)0x80000000) + 0x0)),
                      (128 * 1024 * 1024), DIFFTEST_TO_REF);
  ref_difftest_regcpy(&cpu, DIFFTEST_TO_REF);
  detach = 0;
  return;
};
