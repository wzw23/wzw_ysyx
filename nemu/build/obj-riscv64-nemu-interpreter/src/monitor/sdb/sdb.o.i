...
# 23 "/usr/include/readline/readline.h" 3 4
#define _READLINE_H_
# 36 "/usr/include/readline/readline.h" 3 4
# 1 "/usr/include/readline/rlstdc.h" 1 3 4
# 23 "/usr/include/readline/rlstdc.h" 3 4
#define _RL_STDC_H_
# 33 "/usr/include/readline/rlstdc.h" 3 4
...
# 23 "/usr/include/readline/rltypedefs.h" 3 4
#define _RL_TYPEDEFS_H_
# 32 "/usr/include/readline/rltypedefs.h" 3 4
...
# 51 "/usr/include/readline/rltypedefs.h" 3 4
...
# 41 "/usr/include/readline/chardefs.h" 3 4
...
# 70 "/usr/include/readline/chardefs.h" 3 4
...
# 24 "/usr/include/readline/tilde.h" 3 4
#define _TILDE_H_
...
# 23 "/usr/include/readline/history.h" 3 4
#define _HISTORY_H_
...
# 50 "src/monitor/sdb/sdb.c" 3 4
      ((void *)0)
# 50 "src/monitor/sdb/sdb.c"
      ;

  if (line_read) {
    free(line_read);
    line_read =
# 54 "src/monitor/sdb/sdb.c" 3 4
        ((void *)0)
# 54 "src/monitor/sdb/sdb.c"
        ;
  }
...
static int cmd_si(char *args) {
  char *arg2 = strtok(
# 88 "src/monitor/sdb/sdb.c" 3 4
      ((void *)0)
# 88 "src/monitor/sdb/sdb.c"
          ,
      " ");
  cpu_exec(atoi(arg2));
  return 0;
...
# 97 "src/monitor/sdb/sdb.c" 3 4
  _Bool
# 97 "src/monitor/sdb/sdb.c"
      success;
  int n = atoi(N);

  char *EXPR = strtok(
# 100 "src/monitor/sdb/sdb.c" 3 4
      ((void *)0)
# 100 "src/monitor/sdb/sdb.c"
          ,
      " ");
...
# 133 "src/monitor/sdb/sdb.c" 3 4
  _Bool
# 133 "src/monitor/sdb/sdb.c"
      success;
  char buffer[65536];
  int totalRead = 0;
  FILE *fp = fopen("/home/wzw/ysyx-workbench/nemu/tools/gen-expr/log", "r");
  if (fp ==
# 137 "src/monitor/sdb/sdb.c" 3 4
      ((void *)0)
# 137 "src/monitor/sdb/sdb.c"
  ) {
...
# 142 "src/monitor/sdb/sdb.c"
    ...
    ret = strtok(
# 152 "src/monitor/sdb/sdb.c" 3 4
        ((void *)0)
# 152 "src/monitor/sdb/sdb.c"
            ,
        "\0");
    char *test_exp = ret;
...
# 182 "src/monitor/sdb/sdb.c"
  ...
  if (!strcmp(arg, "r"))
    ...
    WP *jd = head;
    while (jd !=
# 188 "src/monitor/sdb/sdb.c" 3 4
           ((void *)0)
# 188 "src/monitor/sdb/sdb.c"
    ) {
...
# 199 "src/monitor/sdb/sdb.c" 3 4
  _Bool
# 199 "src/monitor/sdb/sdb.c"
      success;

  char *arg = strtok(
# 202 "src/monitor/sdb/sdb.c" 3 4
      ((void *)0)
# 202 "src/monitor/sdb/sdb.c"
          ,
      "\0");
  uint64_t result = expr(arg, &success);
...
# 220 "src/monitor/sdb/sdb.c" 3 4
    _Bool
# 220 "src/monitor/sdb/sdb.c"
        success;
...
static int cmd_d() {
  char *arg = strtok(
# 238 "src/monitor/sdb/sdb.c" 3 4
      ((void *)0)
# 238 "src/monitor/sdb/sdb.c"
          ,
      "\0");
  int n = atoi(arg);
  WP *jd = head;
  ...
  while (jd !=
# 242 "src/monitor/sdb/sdb.c" 3 4
         ((void *)0)
# 242 "src/monitor/sdb/sdb.c"
  ) {
    if (jd->NO == n) {
      head = free_wp(jd);
      break;
...
static int cmd_help(char *args) {
  ...
  char *arg = strtok(
# 282 "src/monitor/sdb/sdb.c" 3 4
      ((void *)0)
# 282 "src/monitor/sdb/sdb.c"
          ,
      " ");
  int i;
...
void sdb_set_batch_mode() {
  is_batch_mode =
# 304 "src/monitor/sdb/sdb.c" 3 4
      1
# 304 "src/monitor/sdb/sdb.c"
      ;
}
...
void sdb_mainloop() {
  if (is_batch_mode) {
    cmd_c(
# 309 "src/monitor/sdb/sdb.c" 3 4
        ((void *)0)
# 309 "src/monitor/sdb/sdb.c"
    );
    return;
  }

  for (char *str; (str = rl_gets()) !=
# 313 "src/monitor/sdb/sdb.c" 3 4
                  ((void *)0)
# 313 "src/monitor/sdb/sdb.c"
           ;) {
    char *str_end = str + strlen(str);

    char *cmd = strtok(str, " ");
    if (cmd ==
# 318 "src/monitor/sdb/sdb.c" 3 4
        ((void *)0)
# 318 "src/monitor/sdb/sdb.c"
    ) {
      continue;
    }
