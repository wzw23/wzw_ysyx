...
# 401 "/usr/include/regex.h" 3 4
#define __RE_TRANSLATE_TYPE unsigned char *
# 410 "/usr/include/regex.h" 3 4
...
# 649 "/usr/include/regex.h" 3 4
#define _Restrict_ __restrict
# 663 "/usr/include/regex.h" 3 4
...
extern int regexec(const regex_t *__restrict __preg,
                   ...
                   regmatch_t __pmatch[__restrict __nmatch], int __eflags);
      ...
      if (regexec(&re[i], e + position, 1, &pmatch, 0) == 0 &&
        ...
        do {
          printf("\33[1;34m"
                 ...
                 "\33[0m"
                 "\n",
                 "src/monitor/sdb/expr.c", 124, __func__, i, rules[i].regex,
                 position, substr_len, substr_len, substr_start);
          do {
            extern FILE *log_fp;
            extern
# 124 "src/monitor/sdb/expr.c" 3 4
                _Bool
# 124 "src/monitor/sdb/expr.c"
                log_enable();
            if (log_enable()) {
              fprintf(
                  log_fp,
...
# 151 "src/monitor/sdb/expr.c" 3 4
          ((void)sizeof((
# 151 "src/monitor/sdb/expr.c"
                            1
# 151 "src/monitor/sdb/expr.c" 3 4
                            )
                            ? 1
...
# 195 "src/monitor/sdb/expr.c" 3 4
          _Bool
# 195 "src/monitor/sdb/expr.c"
              success[1] = {0};
          ...
          if (!strcmp(regstr, "pc")) {
            ...
            *success = 1;
            ...
            reg = isa_reg_str2val(regstr, success);
          }
        ...
        default:
          do {
            if (!(0)) {
              (fflush(
# 231 "src/monitor/sdb/expr.c" 3 4
                   stdout
# 231 "src/monitor/sdb/expr.c"
                   ),
               fprintf(
# 231 "src/monitor/sdb/expr.c" 3 4
                   stderr
...
static Token *P_operator(Token *p, Token *q) {
  ...
  while (pa <= qa) {
    ...
    if ((pa->type == '+') || (pa->type == '-') || (pa->type == '*') ||
        (pa->type == '/') || (pa->type == TK_NEQ) || (pa->type == TK_EQ) ||
        (pa->type == TK_AND) || (pa->type == DEREF) || (pa->type == NEG)) {
      if (pa->type == '+' || pa->type == '-')
        Yx = 4;
...
static
# 305 "src/monitor/sdb/expr.c" 3 4
    _Bool
# 305 "src/monitor/sdb/expr.c"
...
static uint64_t eval(Token *p, Token *q) {
  if (p > q) {
    ...
    if (p->type == TK_NUM) {
      uint64_t fh = (uint64_t)strtol(p->str,
# 321 "src/monitor/sdb/expr.c" 3 4
                                     ((void *)0)
# 321 "src/monitor/sdb/expr.c"
                                         ,
                                     10);
...
# 330 "src/monitor/sdb/expr.c" 3 4
             1
# 330 "src/monitor/sdb/expr.c"
  ) {
    ...
    case NEG:
      return -val2;
    default:
# 366 "src/monitor/sdb/expr.c" 3 4
      ((void)sizeof((
# 366 "src/monitor/sdb/expr.c"
                        0
# 366 "src/monitor/sdb/expr.c" 3 4
                        )
                        ? 1
...
static
# 373 "src/monitor/sdb/expr.c" 3 4
    _Bool
# 373 "src/monitor/sdb/expr.c"
    check_parentheses(Token *p, Token *q) {

  if (strcmp((p)->str, "(") || strcmp((q)->str, ")")) {
    return
# 381 "src/monitor/sdb/expr.c" 3 4
        0
# 381 "src/monitor/sdb/expr.c"
        ;
  }
  Token *pa = p + 1;
  Token *qa = q - 1;
...
# 395 "src/monitor/sdb/expr.c"
  ...
  if (k == 0)
    return
# 402 "src/monitor/sdb/expr.c" 3 4
        1
# 402 "src/monitor/sdb/expr.c"
        ;
  else {
    k = 0;
    return
# 405 "src/monitor/sdb/expr.c" 3 4
        0
# 405 "src/monitor/sdb/expr.c"
        ;
  }
}
...
# 409 "src/monitor/sdb/expr.c"
  ...
  if (!make_token(e)) {
    *success =
# 411 "src/monitor/sdb/expr.c" 3 4
        0
# 411 "src/monitor/sdb/expr.c"
        ;
    return -1;
  } else {
    for (int i = 0; i < j; i++) {
