...
# 32 "src/monitor/monitor.c"
  ...
  do {
    ...
    do {
      extern FILE *log_fp;
      extern
# 36 "src/monitor/monitor.c" 3 4
          _Bool
# 36 "src/monitor/monitor.c"
          log_enable();
      if (log_enable()) {
        fprintf(log_fp,
                "\33[1;34m"
...
# 22 "/usr/include/getopt.h" 3 4
#define _GETOPT_H 1
# 32 "/usr/include/getopt.h" 3 4
...
# 21 "/usr/include/x86_64-linux-gnu/bits/getopt_ext.h" 3 4
...
# 45 "src/monitor/monitor.c" 2

# 46 "src/monitor/monitor.c"
void sdb_set_batch_mode();

static char *log_file =
# 48 "src/monitor/monitor.c" 3 4
    ((void *)0)
# 48 "src/monitor/monitor.c"
    ;

static char *elf_file =
# 50 "src/monitor/monitor.c" 3 4
    ((void *)0)
# 50 "src/monitor/monitor.c"
    ;
...
# 53 "src/monitor/monitor.c" 3 4
    ((void *)0)
# 53 "src/monitor/monitor.c"
    ;
...
# 57 "src/monitor/monitor.c"
    ...
    do {
      printf("\33[1;34m"
             ...
             "\33[0m"
             "\n",
             "src/monitor/monitor.c", 58, __func__);
      do {
        extern FILE *log_fp;
        extern
# 58 "src/monitor/monitor.c" 3 4
            _Bool
# 58 "src/monitor/monitor.c"
            log_enable();
        if (log_enable()) {
          fprintf(log_fp,
                  "\33[1;34m"
  ...
  do {
    if (!(fp)) {
      (fflush(
# 63 "src/monitor/monitor.c" 3 4
           stdout
# 63 "src/monitor/monitor.c"
           ),
       fprintf(
# 63 "src/monitor/monitor.c" 3 4
           stderr
...
# 63 "src/monitor/monitor.c"
  ...
  fseek(fp, 0,
# 65 "src/monitor/monitor.c" 3 4
        2
# 65 "src/monitor/monitor.c"
  );
  long size = ftell(fp);
  ...
  do {
    printf("\33[1;34m"
           ...
           "\33[0m"
           "\n",
           "src/monitor/monitor.c", 68, __func__, img_file, size);
    do {
      extern FILE *log_fp;
      extern
...
# 68 "src/monitor/monitor.c"
  ...
  fseek(fp, 0,
# 70 "src/monitor/monitor.c" 3 4
        0
# 70 "src/monitor/monitor.c"
  );
  int ret = fread(guest_to_host((((paddr_t)0x80000000) + 0x0)), size, 1, fp);

# 72 "src/monitor/monitor.c" 3 4
  ((void)sizeof((
# 72 "src/monitor/monitor.c"
                    ret == 1
# 72 "src/monitor/monitor.c" 3 4
                    )
                    ? 1
...
# 72 "src/monitor/monitor.c" 3 4
           ,
           "src/monitor/monitor.c", 72, __extension__ __PRETTY_FUNCTION__);
   }))
# 72 "src/monitor/monitor.c"
      ;
...
# 85 "src/monitor/monitor.c"
  ...
  int o;
  while ((o = getopt_long(argc, argv, "-bhl:e:d:p:", table,
# 88 "src/monitor/monitor.c" 3 4
                          ((void *)0)
# 88 "src/monitor/monitor.c"
                              )) != -1) {
    switch (o) {
    case 'b':
      sdb_set_batch_mode();
    ...
    default:
      ...
      printf("\t-e      =FILE           output elf to FILE\n");
