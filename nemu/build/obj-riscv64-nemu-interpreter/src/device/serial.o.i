...
# 20 "/home/wzw/ysyx-workbench/nemu/include/utils.h" 2
...
# 18 "src/device/serial.c" 2

#define CH_OFFSET 0

static uint8_t *serial_base =
# 24 "src/device/serial.c" 3 4
    ((void *)0)
# 24 "src/device/serial.c"
    ;

static void serial_putc(char ch) {
  putc(ch,
# 28 "src/device/serial.c" 3 4
       stderr
...
# 31 "src/device/serial.c" 3 4
                              _Bool
# 31 "src/device/serial.c"
                                  is_write) {

# 32 "src/device/serial.c" 3 4
  ((void)sizeof((
# 32 "src/device/serial.c"
                    len == 1
# 32 "src/device/serial.c" 3 4
                    )
                    ? 1
...
# 32 "src/device/serial.c" 3 4
           ,
           "src/device/serial.c", 32, __extension__ __PRETTY_FUNCTION__);
   }))
# 32 "src/device/serial.c"
      ;
  switch (offset) {
  ...
  case 0:
    if (is_write)
      ...
      do {
        if (!(0)) {
          (fflush(
# 37 "src/device/serial.c" 3 4
               stdout
# 37 "src/device/serial.c"
               ),
           fprintf(
# 37 "src/device/serial.c" 3 4
               stderr
...
# 37 "src/device/serial.c"
  ...
  default:
    do {
      if (!(0)) {
        (fflush(
# 39 "src/device/serial.c" 3 4
             stdout
# 39 "src/device/serial.c"
             ),
         fprintf(
# 39 "src/device/serial.c" 3 4
             stderr
...
# 39 "src/device/serial.c" 3 4
                 ,
                 "src/device/serial.c", 39, __extension__ __PRETTY_FUNCTION__);
         }))
# 39 "src/device/serial.c"
            ;
      }
...
void init_serial() {
  ...
  add_mmio_map("serial", 0xa00003f8, serial_base, 8, serial_io_handler);
}
