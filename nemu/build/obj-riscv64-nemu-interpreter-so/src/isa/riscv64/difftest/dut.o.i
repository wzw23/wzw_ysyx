...
# 17 "src/isa/riscv64/difftest/../local-include/reg.h"
...
# 22 "src/isa/riscv64/difftest/../local-include/reg.h" 3 4
           ,
           "src/isa/riscv64/difftest/../local-include/reg.h", 22,
...
# 20 "src/isa/riscv64/difftest/dut.c"
  ...
  if (ref_r->pc != cpu.pc)
    return
# 22 "src/isa/riscv64/difftest/dut.c" 3 4
        0
# 22 "src/isa/riscv64/difftest/dut.c"
        ;
  for (int i = 0; i < 32; i++) {
    if (ref_r->gpr[i] != cpu.gpr[i])
      return
# 25 "src/isa/riscv64/difftest/dut.c" 3 4
          0
# 25 "src/isa/riscv64/difftest/dut.c"
          ;
  }
  return
