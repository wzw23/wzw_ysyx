...
# 20 "/home/wzw/ysyx-workbench/nemu/include/cpu/cpu.h" 2
...
# 1 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 1
# 17 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
#define __CPU_DIFFTEST_H__

# 1 "/home/wzw/ysyx-workbench/nemu/include/difftest-def.h" 1
# 17 "/home/wzw/ysyx-workbench/nemu/include/difftest-def.h"
...
#define CONFIG_ISA "riscv64"
#define CONFIG_PMEM_GARRAY 1
# 21 "/home/wzw/ysyx-workbench/nemu/include/difftest-def.h" 2

enum { DIFFTEST_TO_DUT, DIFFTEST_TO_REF };
# 31 "/home/wzw/ysyx-workbench/nemu/include/difftest-def.h"
#define DIFFTEST_REG_SIZE (sizeof(uint64_t) * 33)
# 21 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 2
# 30 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
...
# 38 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 3 4
                                   _Bool
# 38 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
                                       direction);
extern void (*ref_difftest_regcpy)(void *dut,
# 39 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 3 4
                                   _Bool
# 39 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
                                       direction);
extern void (*ref_difftest_exec)(uint64_t n);
extern void (*ref_difftest_raise_intr)(uint64_t NO);

static inline
# 43 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 3 4
    _Bool
# 43 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
  ...
  if (ref != dut) {
    do {
      printf("\33[1;34m"
             ...
             "0x%016"
# 45 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 3 4
             "l"
             "x"
# 45 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
             ", right = "
             "0x%016"
# 45 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 3 4
             "l"
...
# 45 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
             "\33[0m"
             "\n",
             "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h", 45,
             __func__, name, pc, ref, dut, ref ^ dut);
      ;
    } while (0)

        ;
    return
# 48 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 3 4
        0
# 48 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
        ;
  }
  return
# 50 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 3 4
      1
# 50 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h"
      ;
}
...
# 22 "src/cpu/cpu-exec.c" 2

#define MAX_INST_TO_PRINT 10

# 29 "src/cpu/cpu-exec.c"
CPU_state cpu = {};
...
static
# 63 "src/cpu/cpu-exec.c" 3 4
    _Bool
# 63 "src/cpu/cpu-exec.c"
        g_print_step =
# 63 "src/cpu/cpu-exec.c" 3 4
            0
# 63 "src/cpu/cpu-exec.c"
...
static void statistic() {
  setlocale(
# 180 "src/cpu/cpu-exec.c" 3 4
      1
# 180 "src/cpu/cpu-exec.c"
      ,
      "");
#define NUMBERIC_FMT MUXDEF(CONFIG_TARGET_AM, "%", "%'") PRIu64
  do {
    printf("\33[1;34m"
           ...
           "host time spent = "
           "%'"
# 182 "src/cpu/cpu-exec.c" 3 4
           "l"
           "u"
# 182 "src/cpu/cpu-exec.c"
           " us"
           "\33[0m"
           "\n",
           "src/cpu/cpu-exec.c", 182, __func__, g_timer);
    ;
  } while (0);
  do {
    printf("\33[1;34m"
...
# 183 "src/cpu/cpu-exec.c"
           "\33[0m"
           "\n",
           "src/cpu/cpu-exec.c", 183, __func__, g_nr_guest_inst);
    ;
  } while (0);
  if (g_timer > 0)
    do {
      printf("\33[1;34m"
             ...
             "%'"
# 184 "src/cpu/cpu-exec.c" 3 4
             "l"
             "u"
# 184 "src/cpu/cpu-exec.c"
             " inst/s"
             "\33[0m"
             "\n",
             "src/cpu/cpu-exec.c", 184, __func__,
    ...
    do {
      printf("\33[1;34m"
             ...
             "\33[0m"
             "\n",
             "src/cpu/cpu-exec.c", 185, __func__);
      ;
    } while (0);
}
  ...
  case NEMU_ABORT:
    do {
      printf("\33[1;34m"
             ...
             "nemu: %s at pc = "
             "0x%016"
# 218 "src/cpu/cpu-exec.c" 3 4
             "l"
             "x"
# 218 "src/cpu/cpu-exec.c"
             "\33[0m"
             "\n",
             "src/cpu/cpu-exec.c", 218, __func__,
