...
# 20 "/home/wzw/ysyx-workbench/nemu/include/cpu/difftest.h" 2
...
# 17 "src/device/io/mmio.c" 2
# 1 "/home/wzw/ysyx-workbench/nemu/include/memory/paddr.h" 1
# 17 "/home/wzw/ysyx-workbench/nemu/include/memory/paddr.h"
...
static inline
# 30 "/home/wzw/ysyx-workbench/nemu/include/memory/paddr.h" 3 4
    _Bool
# 30 "/home/wzw/ysyx-workbench/nemu/include/memory/paddr.h"
...
static IOMap *fetch_mmio_map(paddr_t addr) {
  ...
  return (mapid == -1 ?
# 26 "src/device/io/mmio.c" 3 4
                      ((void *)0)
# 26 "src/device/io/mmio.c"
                      : &maps[mapid]);
}
...
static void report_mmio_overlap(const char *name1, paddr_t l1, paddr_t r1,
  ...
  do {
    if (!(0)) {
      (fflush(
# 31 "src/device/io/mmio.c" 3 4
           stdout
# 31 "src/device/io/mmio.c"
           ),
       fprintf(
# 31 "src/device/io/mmio.c" 3 4
           stderr
...
# 31 "src/device/io/mmio.c" 3 4
               ,
               "src/device/io/mmio.c", 31, __extension__ __PRETTY_FUNCTION__);
       }))
# 31 "src/device/io/mmio.c"
          ;
    }
...
# 37 "src/device/io/mmio.c" 3 4
  ((void)sizeof((
# 37 "src/device/io/mmio.c"
                    nr_map < 16
# 37 "src/device/io/mmio.c" 3 4
                    )
                    ? 1
...
# 37 "src/device/io/mmio.c"
  ...
  if (in_pmem(left) || in_pmem(right)) {
    report_mmio_overlap(name, left, right, "pmem", ((paddr_t)0x80000000),
                        ((paddr_t)0x80000000 + 0x8000000 - 1));
  }
  ...
  do {
    printf("\33[1;34m"
           ...
           "Add mmio map '%s' at ["
           "0x%08"
# 50 "src/device/io/mmio.c" 3 4
           "x"
# 50 "src/device/io/mmio.c"
           ", "
           "0x%08"
# 50 "src/device/io/mmio.c" 3 4
           "x"
# 50 "src/device/io/mmio.c"
           ...
           "\33[0m"
           "\n",
           "src/device/io/mmio.c", 50, __func__, maps[nr_map].name,
