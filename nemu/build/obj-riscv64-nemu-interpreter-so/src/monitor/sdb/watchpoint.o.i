...
static WP *head =
# 34 "src/monitor/sdb/watchpoint.c" 3 4
              ((void *)0)
# 34 "src/monitor/sdb/watchpoint.c"
    ,
          *free_ =
# 34 "src/monitor/sdb/watchpoint.c" 3 4
              ((void *)0)
...
# 40 "src/monitor/sdb/watchpoint.c" 3 4
                                   ((void *)0)
# 40 "src/monitor/sdb/watchpoint.c"
                                   : &wp_pool[i + 1]);
    wp_pool[i].p_data = 0;
    wp_pool[i].n_data = 0;
...
WP *new_wp(uint64_t data, char *arg) {
  printf("new_wp bigin");
  if (free_ ==
# 53 "src/monitor/sdb/watchpoint.c" 3 4
      ((void *)0)
# 53 "src/monitor/sdb/watchpoint.c"
  )
...
# 54 "src/monitor/sdb/watchpoint.c" 3 4
             ,
             "src/monitor/sdb/watchpoint.c", 54,
...
# 54 "src/monitor/sdb/watchpoint.c"
    ...
    free_ = free_ + 1;
    if (head ==
# 62 "src/monitor/sdb/watchpoint.c" 3 4
        ((void *)0)
# 62 "src/monitor/sdb/watchpoint.c"
    ) {
      jd->next =
# 63 "src/monitor/sdb/watchpoint.c" 3 4
          ((void *)0)
# 63 "src/monitor/sdb/watchpoint.c"
          ;
      head = jd;
    } else {
      jd->next = head->next;
...
WP *free_wp(WP *wp) {
  ...
  if (jd2 == wp) {
    ...
    while (jd2->next !=
# 81 "src/monitor/sdb/watchpoint.c" 3 4
           ((void *)0)
# 81 "src/monitor/sdb/watchpoint.c"
    ) {
      if (jd2->next == wp) {
        WP *jd_next = jd2->next;
...
void watchpoint_exam() {
  ...
  WP *test = head;
  while (test !=
# 110 "src/monitor/sdb/watchpoint.c" 3 4
         ((void *)0)
# 110 "src/monitor/sdb/watchpoint.c"
  ) {

# 111 "src/monitor/sdb/watchpoint.c" 3 4
    _Bool
# 111 "src/monitor/sdb/watchpoint.c"
        success;
