...
void Vtop::putstate(int* statefh, int* a0, int* pcr, int* dnpcr, int* callreturn, int* Typer) {
    ...
    (*__Vcb)((Vtop__Syms*)(__Vscopep->symsp()), statefh__Vcvt, a0__Vcvt, pcr__Vcvt, dnpcr__Vcvt, callreturn__Vcvt, Typer__Vcvt);
    ...
    for (size_t Typer__Vidx = 0; Typer__Vidx < 1; ++Typer__Vidx) *Typer = Typer__Vcvt;
}
