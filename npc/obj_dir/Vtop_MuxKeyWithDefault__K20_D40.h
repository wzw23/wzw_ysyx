...
#ifndef VERILATED_VTOP_MUXKEYWITHDEFAULT__K20_D40_H_
#define VERILATED_VTOP_MUXKEYWITHDEFAULT__K20_D40_H_  // guard
...
VL_MODULE(Vtop_MuxKeyWithDefault__K20_D40) {
  public:
    ...
    VlUnpacked<VlWide<3>/*95:0*/, 2> __PVT__i0__DOT__pair_list;
    ...
    VlWide<6>/*191:0*/ __Vtogcov__lut;
    QData/*63:0*/ i0__DOT____Vtogcov__lut_out;
    VlUnpacked<VlWide<3>/*95:0*/, 2> i0__DOT____Vtogcov__pair_list;
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vtop_MuxKeyWithDefault__K20_D40);  ///< Copying not allowed
  public:
    Vtop_MuxKeyWithDefault__K20_D40(const char* name);
